...
| [0033](0033-toolbar-overflow-phone.md) | 幅414px以下でツールバーのボタンが画面から溢れる | open | — |
...
「足すたびに高くなる」は止まった）。残る狭い画面の問題は
[0022](0022-narrow-pane-switch.md)（ソースとプレビューの切り替え）と
[0033](0033-toolbar-overflow-phone.md)（幅414px以下でツールバーが溢れる）で、
**どちらも同じ画面幅の話なので続けてやると測り直しが1回で済む**。
