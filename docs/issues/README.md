...
| [0031](0031-english-ui.md) | 英語に対応する | in-progress | [仕様](../specs/0031-english-ui.md) |
...
**0031（英語対応）は先にやるほど安い。** 画面の文字列が増えるほど翻訳の量が
増え、検証スクリプトが日本語で要素を探している箇所も増える。
ただし0029・0030でデータを足すと、その分だけ翻訳対象も増える。
