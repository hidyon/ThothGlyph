...
export const paletteGroups: PaletteGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: '\\varepsilon', snippet: '\\varepsilon ', title: 'varepsilon（epsilonの別の形）' },
      { label: '\\zeta', snippet: '\\zeta ', title: 'zeta' },
      { label: '\\eta', snippet: '\\eta ', title: 'eta' },
      { label: '\\theta', snippet: '\\theta ', title: 'theta' },
      { label: '\\vartheta', snippet: '\\vartheta ', title: 'vartheta（thetaの別の形）' },
      { label: '\\iota', snippet: '\\iota ', title: 'iota' },
      { label: '\\kappa', snippet: '\\kappa ', title: 'kappa' },
      { label: '\\varkappa', snippet: '\\varkappa ', title: 'varkappa（kappaの別の形）' },
      { label: '\\lambda', snippet: '\\lambda ', title: 'lambda' },
      { label: '\\mu', snippet: '\\mu ', title: 'mu' },
      { label: '\\nu', snippet: '\\nu ', title: 'nu' },
      { label: '\\xi', snippet: '\\xi ', title: 'xi' },
      { label: '\\omicron', snippet: '\\omicron ', title: 'omicron' },
      { label: '\\pi', snippet: '\\pi ', title: 'pi' },
      { label: '\\varpi', snippet: '\\varpi ', title: 'varpi（piの別の形）' },
      { label: '\\rho', snippet: '\\rho ', title: 'rho' },
      { label: '\\varrho', snippet: '\\varrho ', title: 'varrho（rhoの別の形）' },
      { label: '\\sigma', snippet: '\\sigma ', title: 'sigma' },
      { label: '\\varsigma', snippet: '\\varsigma ', title: 'varsigma（sigmaの別の形）' },
      { label: '\\tau', snippet: '\\tau ', title: 'tau' },
      { label: '\\upsilon', snippet: '\\upsilon ', title: 'upsilon' },
      { label: '\\phi', snippet: '\\phi ', title: 'phi' },
      { label: '\\varphi', snippet: '\\varphi ', title: 'varphi（phiの別の形）' },
      { label: '\\chi', snippet: '\\chi ', title: 'chi' },
      { label: '\\psi', snippet: '\\psi ', title: 'psi' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: '\\Lambda', snippet: '\\Lambda ', title: 'Lambda（大文字）' },
      { label: '\\Xi', snippet: '\\Xi ', title: 'Xi（大文字）' },
      { label: '\\Pi', snippet: '\\Pi ', title: 'Pi（大文字）' },
      { label: '\\Sigma', snippet: '\\Sigma ', title: 'Sigma（大文字）' },
      { label: '\\Upsilon', snippet: '\\Upsilon ', title: 'Upsilon（大文字）' },
      { label: '\\Phi', snippet: '\\Phi ', title: 'Phi（大文字）' },
      { label: '\\Psi', snippet: '\\Psi ', title: 'Psi（大文字）' },
